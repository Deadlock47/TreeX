...
//                       <Text className="text-white text-center" style={styles.text}>{`${currentIndex + 1} / ${
//                         data?.screenshots ? data.screenshots.length : 0
//                       }`}</Text>
//                     </View>
//                     <Pressable onTouchEndCapture={()=> {setVisible(false)}} className="absolute right-1 top-5 bg-white  p-2 ">
